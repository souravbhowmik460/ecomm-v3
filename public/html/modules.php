                                    ...
                                    <table class="table table-centered mb-0">
                                        <thead>
                                            <tr>
                                                ...
                                                <th>
                                                    <div class="d-flex align-items-center">
                                                        Module Name <i class="ri-arrow-up-s-line ms-1"></i>
                                                    </div>
                                                </th>
                                                <th>Sequence</th>
                                                <th>Icon</th>
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <span role="button" class="badge badge-success-lighten" title=""
                                                        onclick="">Active</span>
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <span role="button" class="badge badge-danger-lighten" title=""
                                                        onclick="">Inactive</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td>
          ...
          <div class="col-xl-12 col-lg-12">
            <div class="card card-h-100">
              <div class="d-flex card-header justify-content-between align-items-center">
                <h4 class="header-title">Modules List</h4>
                <div class="d-flex align-items-center">
                  <button type="button" class="btn btn btn-soft-secondary btn-sm me-2">Add New</button>
                  <button type="button" class="btn btn-soft-info btn-sm me-2">Refresh</button>
                  <div class="dropdown ms-1">
                    <a href="#" class="dropdown-toggle arrow-none card-drop"
                      data-bs-toggle="dropdown" aria-expanded="false">
                      <i class="mdi mdi-dots-vertical"></i>
