    ...
    <div class="d-flex align-items-center gap-lg-2 gap-1">
      ...
      <div class="logo-topbar">
        ...
        <a href="javascript:" class="logo-light">
          ...
          <span class="logo-sm">
            <img src="assetss/images/logo-sm.svg" alt="small logo">
          </span>
        </a>
      ...
      <button class="button-toggle-menu">
        <img src="assetss/images/svg/ham.svg" alt="hammenu">
      </button>
      ...
      <div class="app-search dropdown d-none d-lg-block">
        ...
        <div class="dropdown-menu dropdown-menu-animated dropdown-lg" id="search-dropdown">
          ...
          <div class="notification-list">
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              <div class="d-flex">
                <img class="d-flex me-2 rounded-circle" src="assetss/images/users/avatar-1.jpg" alt="Generic placeholder image" height="32">
                <div class="w-100">
                ...
                <div class="d-flex align-items-center">
                  <div class="flex-shrink-0">
                    <div class="notify-icon">
                      <img src="assetss/images/users/avatar-1.jpg" class="img-fluid rounded-circle" alt="" />
                    </div>
                  </div>
                  <div class="flex-grow-1 text-truncate ms-2">
      ...
      <li class="dropdown">
        <a class="nav-link dropdown-toggle arrow-none nav-user px-2" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
          <span class="account-user-avatar">
            <img src="assetss/images/users/avatar-1.jpg" alt="user-image" width="32" class="rounded-circle">
          </span>
