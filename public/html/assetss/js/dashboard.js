! function(o) {
	...
	e.prototype.initCharts = function() {
		...
		var e = ["#727cf5", "#0acf97", "#fa5c7c", "#ffbc00"],
            ...
            // t = o("#multiple-radialbar").data("colors"),
            r = {
                chart: {
                    height: 320,
                    type: "radialBar"
                ...
                colors: e = (t = o("#multiple-radialbar").data("colors")) ? t.split(",") : e,
                series: [44, 55, 67],
                labels: ["Interviews", "Joiness", "Attendees"],
                responsive: [{
                    breakpoint: 380,
                    options: {
                        chart: {
			...
			e = (new ApexCharts(document.querySelector("#multiple-radialbar"), r).render(), ["#0acf97", "#727cf5"]),
