        ...
        <!--[if BLOCK]><![endif]--><?php if(count($products) > 0): ?>
          <!--[if BLOCK]><![endif]--><?php $__currentLoopData = $products; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $product): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <tr id="row_<?php echo e($hashedID); ?>">
              ...
              <td><?php echo e($product->cart_count); ?></td>
              <td><?php echo e($product->order_count); ?></td>
              <td>
                <span class="badge bg-success">
                  <?php echo e(number_format($product->conversion_rate, 2)); ?>%
                </span>
              </td>
            </tr>
...
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/livewire/reports/top-conversion-products-table.blade.php ENDPATH**/ ?>