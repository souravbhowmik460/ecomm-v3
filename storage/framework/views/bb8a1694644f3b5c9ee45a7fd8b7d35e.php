...
<?php endif; ?>
  ...
  <div class="row">
    <div class="col-xl-6 col-lg-6">
      <?php echo $__env->make('backend.includes.conversion-status', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>

    <div class="col-xl-6 col-lg-6">
      <?php echo $__env->make('backend.includes.cart-order-comparison', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </div>
...
<?php $component = App\View\Components\ListCard::resolve(['cardHeader' => 'Top Converting Products','baseRoute' => 'admin.departments','addBtnShow' => false] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('reports.top-conversion-products-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-1666359080-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/pages/reports/conversion-analytics/index.blade.php ENDPATH**/ ?>