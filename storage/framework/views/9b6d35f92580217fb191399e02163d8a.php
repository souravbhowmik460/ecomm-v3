    ...
    <div class="d-flex card-header justify-content-between align-items-center">
      ...
      <div class="dropdown ms-1">
        ...
        <div class="dropdown-menu dropdown-menu-end">
          ...
          <a href="<?php echo e(route('admin.inventory-export-csv')); ?>" class="dropdown-item">Export to CSV</a>
        </div>
      </div>
    </div>
    ...
    <div class="card-body d-flex flex-column justify-content-start">
      <div class="text-center mb-3">
        ...
        <p class="text-muted mb-2">
          ...
          <span class="text-info" id="inventory-month-label"><?php echo e(\Carbon\Carbon::now()->format('F Y')); ?></span>
        </p>
      </div>
      ...
      <div class="mt-3 d-flex justify-content-end">
        <a class="btn btn-outline-light btn-sm" href="<?php echo e(route('admin.orders')); ?>">View All</a>
      </div>
    </div>
  </div>
</div>
...
<?php $__env->startPush('component-scripts'); ?>
  <script>
    document.addEventListener("DOMContentLoaded", function() {
      fetch("<?php echo e(route('admin.inventory-overview-json')); ?>")
        .then(res => res.json())
        .then(data => {
          // Update summary text
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/includes/inventory.blade.php ENDPATH**/ ?>