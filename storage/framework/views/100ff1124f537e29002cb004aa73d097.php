                    ...
                    <div class="profile_order_return_box border">
                          ...
                          <div class="txts flow-rootx2">
                            <div class="txt">
                              <h4 class="font20 mb-0 fw-normal c--blackc">
                                <?php echo e($statuses[$currentStatus] ?? 'Unknown Status'); ?></h4>
                              <div class="date font14 c--gry">on
                                <?php echo e(\Carbon\Carbon::parse($order['updated_at'])->format('D, j M Y')); ?></div>
                              <div class="date font14 c--gry"><?php echo e('#' . $order['order_number']); ?></div>
                              <div class="date font14 c--gry"><?php echo e(displayPrice($order['net_total'])); ?></div>
                            </div>
                          </div>
                        </div>
                        <div class="viewdetails"><a href="<?php echo e(route('order.details', $order['order_number'])); ?>"
                      ...
                      <?php $__currentLoopData = $order->orderProducts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <div class="product_details py-4">
                          <a href="<?php echo e(route('product.show', $item->variant->sku)); ?>"
                            title="<?php echo e($item->variant->name); ?>"></a>
                          ...
                          <div class="details">
                            <h3 class="font35 fw-normal c--blackc mb-2"><?php echo e($item->variant->name); ?></h3>
                      ...
                      <?php if($order->order_status != 3): ?>
                        <div class="exchange border-top border-bottom py-4">
                          <a class="btn btn-dark btn-lg px-4 py-2" href="javascript:void();"
                            title="<?php echo e($returnType); ?> Order"
                            onclick="needHelp('<?php echo e(Hashids::encode($order->id)); ?>', '<?php echo e($returnType); ?>')">
                            <?php echo e($returnType); ?> Order
                          </a>
                        </div>
                      <?php endif; ?>
  ...
  <script>
    ...
    $('#helpForm').validate({
      ...
      submitHandler: function(form, event) {
        ...
        $.ajax({
          url: '<?php echo e(route('order.return.save')); ?>',
          type: 'POST',
          data: $(form).serialize(),
          success: function(response) {
            if (response.success) {
...
<?php echo $__env->make('frontend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/frontend/pages/user/orders/index.blade.php ENDPATH**/ ?>