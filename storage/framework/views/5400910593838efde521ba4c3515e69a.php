  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const fetchChartData = (start, end) => {
        fetch('<?php echo e(route('admin.reports.cart-order-comparison-json')); ?>', {
            method: 'POST',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/includes/cart-order-comparison.blade.php ENDPATH**/ ?>