  ...
  <script>
    (function($) {
      const config = {
        ...
        defaultCategory: '<?php echo e($productVariant->category->slug ?? ''); ?>'
      };
      let swiper;
      ...
      function fetchProducts(categorySlug) {
        ...
        $.get(config.urls.collections, {
            ...
            excludeProductId: `<?php echo e($productVariant->product_id ?? ''); ?>`,
          })
          .done(response => {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/frontend/includes/checkout-more-products.blade.php ENDPATH**/ ?>