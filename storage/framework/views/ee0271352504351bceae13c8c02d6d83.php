...
<?php $component = App\View\Components\ListCard::resolve(['cardHeader' => 'Shipping & Delivery','baseRoute' => 'admin.orders','addBtnShow' => false] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
[$__name, $__params] = $__split('order-manage.shipping-billing-table', []);

$__html = app('livewire')->mount($__name, $__params, 'lw-3762241305-0', $__slots ?? [], get_defined_vars());
...
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/includes/shipping-delivery.blade.php ENDPATH**/ ?>