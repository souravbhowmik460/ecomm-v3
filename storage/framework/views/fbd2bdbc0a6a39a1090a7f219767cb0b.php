...
<?php $component = App\View\Components\ListCard::resolve(['cardHeader' => $cardHeader,'baseRoute' => 'admin.orders'] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-318350272-0', $__slots ?? [], get_defined_vars());
...
<?php $__env->startSection('page-scripts'); ?>
  <script>
    $(document).ready(function() {
      ...
      //   fetch("<?php echo e(route('admin.chatbot-ask')); ?>", {
      //       method: "POST",
      //       headers: {
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/pages/order-manage/orders/index.blade.php ENDPATH**/ ?>