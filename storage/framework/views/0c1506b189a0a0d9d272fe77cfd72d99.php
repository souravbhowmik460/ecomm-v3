...
<div class="review-wrapper flow-rootX2" id="allReviews">
    ...
    <?php if(auth()->guard()->check()): ?>
      <?php if($hasCompletedOrder): ?>
        <a href="javascript:void(0);" class="action_addreview d-flex align-items-center gap-2 open-review-modal"
          data-bs-toggle="modal" data-bs-target="#WriteReviewModal" data-variant-id="<?php echo e($productVariant->id); ?>"
          data-variant-name="<?php echo e($productVariant->name); ?>" data-review-id="<?php echo e($productVariant->variantReview->id ?? ''); ?>"
          data-review-productreview="<?php echo e($productVariant->variantReview->productreview ?? ''); ?>"
          data-image="<?php echo e($defaultImage ? asset('public/storage/uploads/media/products/images/' . $defaultImage) : asset('public/backend/assetss/images/products/product_thumb.jpg')); ?>"><span
            class="material-symbols-outlined font20">edit</span> <u> <?php echo e($isEdit ? 'Edit Review' : 'Rate & Write Review'); ?>
  ...
  <div id="review-container">
    <?php echo $__env->make('frontend.pages.user.includes.review-items', ['moreReviews' => $productReviews], array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
  </div>
  <?php if($productReviews->count() > 2): ?>
    <div class="loadmore text-center mt-3">
      <a href="javascript:void(0)" id="loadMoreBtn" data-offset="3" data-sku="<?php echo e($productVariant->sku); ?>"
  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      btn.onclick = async () => {
        ...
        const res = await fetch("<?php echo e(route('reviews.load-more')); ?>", {
          method: "POST",
          headers: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/frontend/includes/ratings.blade.php ENDPATH**/ ?>