  ...
  <script>
    document.addEventListener('DOMContentLoaded', () => {
      ...
      const fetchData = (start, end) => {
        fetch('<?php echo e(route('admin.reports.product-revenue-json')); ?>', {
            method: 'POST',
            headers: {
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/includes/product-revenue.blade.php ENDPATH**/ ?>