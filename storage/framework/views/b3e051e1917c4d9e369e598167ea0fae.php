...
<?php endif; ?>
  <div class="row">
    <div class="col-xl-6 col-lg-6">
      <?php echo $__env->make('backend.includes.sale-status', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
    <div class="col-xl-6 col-lg-6">
      <?php echo $__env->make('backend.includes.top-selling-product', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
    </div>
  </div>
...
$__html = app('livewire')->mount($__name, $__params, 'lw-2514987746-0', $__slots ?? [], get_defined_vars());
...
<?php echo $__env->make('backend.layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\wamp64\www\ecomm-v3\resources\views/backend/pages/reports/sales-analytics/index.blade.php ENDPATH**/ ?>