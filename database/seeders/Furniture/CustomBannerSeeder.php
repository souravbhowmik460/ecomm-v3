...
class CustomBannerSeeder extends Seeder
{
  ...
  {
    return [
      ['id' => 1, 'title' => 'Dining Tables starting at $199', 'position' => 'ticker', 'settings' => ['speed' => '30000', 'hyper_link' => "$url/product/{$skus[0]}"], 'custom_order' => 6],
      ['id' => 2, 'title' => 'Limited Time Offer: Free throw pillows with sofa purchases', 'position' => 'ticker', 'settings' => ['speed' => '30000', 'hyper_link' => "$url/product/{$skus[1]}"], 'custom_order' => 5],
      ['id' => 3, 'title' => 'Free Shipping on orders over $300', 'position' => 'ticker', 'settings' => ['speed' => '30000', 'hyper_link' => "$url/product/{$skus[2]}"], 'custom_order' => 2, 'deleted_at' => '2025-05-30 01:18:09'],
      ['id' => 4, 'title' => 'Dining Tables starting at $399', 'position' => 'ticker', 'settings' => ['speed' => '5000', 'hyper_link' => "$url/product/{$skus[3]}"], 'custom_order' => 4],
      ['id' => 5, 'title' => 'Free Shipping on orders over $200', 'position' => 'ticker', 'settings' => ['speed' => '5000', 'hyper_link' => "$url/product/{$skus[4]}"], 'custom_order' => 3],
      ['id' => 6, 'title' => 'Limited Time Offer: Free throw pillows with sofa purchases', 'position' => 'ticker', 'settings' => ['speed' => '5000', 'hyper_link' => "$url/product/{$skus[5]}"], 'custom_order' => 2],
  ...
  {
    return [
      ['id' => 8, 'title' => 'Hero Slider 1', 'position' => 'hero', 'settings' => ['image' => 'homeslider1.webp', 'content' => '<p>Comfort Meets Style<br>in Every Corner of Your Home</p>', 'alt_text' => 'ssdas', 'hyper_link' => "$url/product/{$skus[7]}", 'default_image_size' => null], 'custom_order' => 1],
      ['id' => 9, 'title' => 'Hero Slider 2', 'position' => 'hero', 'settings' => ['image' => 'homeslider2.webp', 'content' => '<p>Limited-Time Deal:<br>Up to 40% Off on Sofas</p>', 'alt_text' => 'alt text', 'hyper_link' => "$url/product/{$skus[8]}", 'default_image_size' => null], 'custom_order' => 5],
      ['id' => 10, 'title' => 'Hero Slider 3', 'position' => 'hero', 'settings' => ['image' => 'homeslider3.webp', 'content' => '<p>Exclusive Deal:<br>Up to 30% Off on Chairs - Limited Time Only!</p>', 'alt_text' => null, 'hyper_link' => "$url/product/{$skus[9]}", 'default_image_size' => null], 'custom_order' => 27],
    ];
  }
  ...
  {
    return [
      ['id' => 11, 'title' => 'Left Hover Card', 'position' => 'hover_card', 'settings' => ['image' => 'category_threeblocks_th1.webp', 'content' => '<h4 class="font16 fw-normal text-center mb-0">New Arrival</h4><h3 class="font35 fw-normal text-center">Chair</h3>', 'alt_text' => 'ssdas', 'btn_text' => 'View', 'btn_color' => '#42388f', 'hyper_link' => null, 'product_sku' => $skus[10], 'default_image_size' => null], 'custom_order' => 6],
      ...
      ['id' => 13, 'title' => 'Hover Right', 'position' => 'hover_card', 'settings' => ['image' => 'category_threeblocks_th3.webp', 'content' => '<h4 class="font16 fw-normal text-center mb-0">New Arrival</h4><h3 class="font35 fw-normal text-center">Chair</h3>', 'alt_text' => 'alt', 'btn_text' => 'View', 'btn_color' => '#000000', 'hyper_link' => null, 'product_sku' => $skus[12], 'default_image_size' => null], 'custom_order' => 9],
    ];
  }
  ...
  private function uploadBannerImages()
  {
    ...
    $sourcePath      = public_path('SeederImages/Furniture/banners');
