...
@section('content')
  ...
  <x-form-card :formTitle="$cardHeader" :backRoute="route('admin.product-recommendation')" :formId="'productRecommendationForm'">
    <div class="row">
      <div class="col-md-6">
      ...
      <div class="col-md-6">
        <div class="mb-3 required">
          ...
          <input type="text" id="start_from" name="start_from" class="form-control"
            value="{{ $promotion->start_from ?? '' }}" min="{{ now()->format('Y-m-d\TH:i') }}" autocomplete="off"
            readonly>
          {{-- <p></p> --}}
          <div id="start_from-error-container" class="invalid-feedback"></div>
        </div>
      </div>
      <div class="col-md-6">
        <div class="mb-3 required">
          <label class="form-label">End To</label>
          <input type="text" id="end_to" name="end_to" class="form-control" value="{{ $promotion->end_to ?? '' }}"
            min="{{ now()->format('Y-m-d\TH:i') }}" autocomplete="off" readonly>
          <div id="end_to-error-container" class="invalid-feedback"></div>
        </div>
      </div>
      <div class="col-md-12">
