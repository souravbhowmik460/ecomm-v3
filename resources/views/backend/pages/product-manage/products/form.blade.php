        ...
        <div class="card-body pt-3">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane " id="page3">
              @include('backend.pages.product-manage.products.partials.variant-price-image', ['filter' => false])
...
@section('page-scripts')
  ...
  <script>
    ...
    // Function to reload data into CKEditors from productData
    function reloadCKEditorDataFromProduct() {
      Object.keys(ckeditor5Instances).forEach(field => {
        const content = productData[field] ?? '';
