...
class ProductVariationTable extends BaseComponent
{
  public $productID = 0;
  public $filename = '';
  ...
  public function render()
  {
    ...
    return view('livewire.product-manage.product-variation-table', ['productVariants' => $productVariants, 'basePath' => $basePath, 'serialNumber' => $serialNumber, 'products' => $products]);
  }
}
