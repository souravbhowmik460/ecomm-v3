...
class BestSellerController extends Controller
{
  ...
  {
    view()->share('pageTitle', 'Manage Base Sellers');
  }
  ...
  {
    return view('backend.pages.product-manage.best-sellers.index', [
      'cardHeader' => 'Base Sellers List',
    ]);
  }
  ...
  public function create(): View
  {
    ...
    return view('backend.pages.product-manage.best-sellers.form', [
      'cardHeader' => 'Create Best Seller',
      'base_seller' => new BestSeller(),
      'products' => $products,
