  ...
  public function toArray(Request $request): array
  {
    ...
    $reviewImages = collect($this->variantReviews)
      ->flatMap(function ($review) {
        return collect($review->reviewImages)->map(function ($img) {
    ...
    return [
      ...
      'specifications' => $this->product->specifications ?? null,
      'care_maintenance' => $this->product->care_maintenance ?? null,
      'warranty' => $this->product->warranty ?? null,
