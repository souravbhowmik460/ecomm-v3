...
class AddtoCartRequest extends BaseRequest
{
  ...
  public function rules(): array
  {
    ...
    return [
      ...
      'is_saved_for_later' => 'sometimes|boolean'
    ];
  }
  ...
  public function messages(): array
  {
    return [
      ...
      'quantity.min' => __('validation.minvalue', ['attribute' => 'Quantity', 'min' => '1']),
      'is_saved_for_later.boolean' => __('validation.boolean', ['attribute' => 'Is Saved For Later']),
    ];
  }
}
